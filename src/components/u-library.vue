<template>
    <a :class="$style.root" :more="more">
        ...
        <div v-else :class="$style.more" title="We want to provide our own set of component libraries"></div>
    </a>
</template>
...
.logo[name="kubeworkz"] {
    ...
    margin-top: -5px;
    vertical-align: middle;
    background: url(../assets/logo-kubeworkz.svg) no-repeat;
    background-size: 100%;
}
...
.logo[name="kubevue"] {
    ...
    margin-top: -5px;
    vertical-align: middle;
    background: url(../assets/kubevue-logo.svg) no-repeat;
    background-size: 100%;
}
